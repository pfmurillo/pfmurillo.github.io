export const locales = {
	en: {
		...
		'home.p_front':
			'I integrate sober and elegant <strong>mobile first</strong> interfaces using the latest technologies, in particular the <strong>Svelte</strong> framework, in which I specialise.',
		'home.p_steps':
	...
	fr: {
		...
		'home.p_front':
			"J'intègre des interfaces <strong>mobile first</strong>, sobres et élégantes en utilisant les dernières technologies, notament le framework <strong>Svelte</strong>, dans lequel je me suis spécialisé.",
		'home.p_steps':
			"Quelque soit votre projet, je suis là pour vous accompagner à chaque étape : de la <strong>conception</strong> et du <strong>développement</strong> à l'<strong>hébergement</strong> de votre application. ",
